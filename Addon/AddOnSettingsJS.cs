...
namespace FT_ADDON.Addon
{
    class AddOnSettingsJS : AddOnSettings
    {
        public override bool Setup()
        {
            ...
            if (!udtwo3.createField("Length", "Length(mm)", SAPbobsCOM.BoFieldTypes.db_Float, 0, "", false, SAPbobsCOM.BoFldSubTypes.st_Quantity)) return false;
            if (!udtwo3.createField("Qty_PCS", "Qty PCS", SAPbobsCOM.BoFieldTypes.db_Float, 0, "", false, SAPbobsCOM.BoFldSubTypes.st_Quantity)) return false;
            if (!udtwo3.createField("SONo", "SO Number", SAPbobsCOM.BoFieldTypes.db_Alpha, 50, "", false)) return false;
